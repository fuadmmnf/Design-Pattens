...
//        setContentView(R.layout.activity_main);
        ...
        itemIcon.setImageResource(R.drawable.ic_undo_black_24dp);
        ...
        itemIcon.setImageResource(R.drawable.ic_redo_black_24dp);
        redoButton = itemBuilder.setContentView(itemIcon).build();
        ...
        undoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                resetButtonColor();
                undoButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(MainActivity.this, R.color.colorPrimaryDark)));
        ...
        redoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                resetButtonColor();
                redoButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(MainActivity.this, R.color.colorPrimaryDark)));
    ...
    {
        undoButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(MainActivity.this, R.color.white)));

        redoButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(MainActivity.this, R.color.white)));
